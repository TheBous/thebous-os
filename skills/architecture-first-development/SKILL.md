...
- **Reuse:** Beware the Share: reuse only concepts with the same model, ownership, and change cadence; map contexts otherwise. Add factories, strategies, or interfaces only for concrete runtime variability or a second real implementation.
