...
| `commands/explain-change.md` | Explain a PR, diff, code, implementation change, or text step by step with a visual HTML artifact |
...
| `commands/review-pr-multiharness.md` | Analyze PR with risk-proportional multi-harness coverage and up to eight subagents |
